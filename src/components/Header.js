                        ...
                        <div class="col-12">
                            <div class="navbar-top">
                                ...
                                <a href="index.html" class="web-logo nav-logo">
                                    <img src="../assets/images/logo/1.png" class="img-fluid blur-up lazyload" alt=""></img>
                                </a>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-3">
                                                                        <div class="dropdown-column m-0">
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                                href="product-color-image.html">Variant
                                                                                Image
                                                                                Swatch</a>
                                                                            <a class="dropdown-item"
                                                        ...
                                                        <li class="nav-item dropdown new-nav-item">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li class="sub-dropdown-hover">
                                                                    ...
                                                                    <ul class="sub-menu">
                                                                        <li>
                                                                            <a href="https://themes.pixelstrap.com/fastkart/invoice/invoice-1.html">Invoice
                                                                                1</a>
                                                                        </li>

                                                                        <li>
                                                                            <a href="https://themes.pixelstrap.com/fastkart/invoice/invoice-2.html">Invoice
                                                                                2</a>
                                                                        </li>

                                                                        <li>
                                                                            <a href="https://themes.pixelstrap.com/fastkart/invoice/invoice-3.html">Invoice
                                                                                3</a>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                            ...
                                                            <div class="drop-cart">
                                                                <a href="product-left-thumbnail.html" class="drop-image">
                                                                    <img src="../assets/images/vegetable/product/1.png"
                                                                        class="blur-up lazyload" alt=""></img>
                                                                </a>
